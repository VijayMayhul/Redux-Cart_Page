...
//Importing useSelector and useDispatch from react-redux third party library to fetch and update data from store
import { useDispatch, useSelector } from "react-redux";

//ProductList component's style sheet
import "./ProductList.css";

//Importing reducer actions to update the state
import {
  DecreaseQuantity,
  IncreaseQuantity,
  RemoveCart,
...
const ProductList = () => {
  ...
  //useDispatch used to update data/state from the product store
  const dispatch = useDispatch();

  //through increaseQuantity function we trigger the IncreaseQuantity action using dispatch method to increase the quantity of a particular product
  const increaseQuantity = (id, qua) => {
    let param = { proId: id, proQua: qua };
    dispatch(IncreaseQuantity(param));
  };

  //through decreaseQuantity function we trigger the DecreaseQuantity action using dispatch method to decrease the quantity of a particular product
